...
export const UserHealthDataList = ({ updateUserHealthData, onUpdateUserHealthData }: Props) => {
    ...
    // lastUserHealthData can be either a UserHealthDataEntry or null
    // This is because we want to set it to null when the component mounts
    ...
    const fetchData = () => {
        ...
        if (historicalUserHealthData.length > 0) {
            setLastUserHealthData(historicalUserHealthData[0]);
        } else {
